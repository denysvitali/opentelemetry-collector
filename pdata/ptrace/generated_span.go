...
func NewSpan() Span {
	...
	return newSpan(otlptrace.Span_builder{}.Build(), &state)
}
...
func (ms Span) DroppedEventsCount() uint32 {
	return ms.orig.GetDroppedEventsCount()
}
...
func (ms Span) SetDroppedEventsCount(v uint32) {
	ms.state.AssertMutable()
	ms.orig.SetDroppedEventsCount(v)
}
