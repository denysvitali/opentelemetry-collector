...
func NewExportPartialSuccess() ExportPartialSuccess {
	...
	return newExportPartialSuccess(otlpcollectortrace.ExportTracePartialSuccess_builder{}.Build(), &state)
}
...
func (ms ExportPartialSuccess) RejectedSpans() int64 {
	return ms.orig.GetRejectedSpans()
}
