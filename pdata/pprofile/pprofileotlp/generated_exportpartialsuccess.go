...
func NewExportPartialSuccess() ExportPartialSuccess {
	...
	return newExportPartialSuccess(otlpcollectorprofile.ExportProfilesPartialSuccess_builder{}.Build(), &state)
}
...
func (ms ExportPartialSuccess) RejectedProfiles() int64 {
	return ms.orig.GetRejectedProfiles()
}
