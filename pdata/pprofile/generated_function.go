...
func NewFunction() Function {
	...
	return newFunction(otlpprofiles.Function_builder{}.Build(), &state)
}
...
func (ms Function) SetSystemNameStrindex(v int32) {
	ms.state.AssertMutable()
	ms.orig.SetSystemNameStrindex(v)
}
