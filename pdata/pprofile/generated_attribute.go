...
func NewAttribute() Attribute {
	...
	return newAttribute(v1.KeyValue_builder{}.Build(), &state)
}
...
func (ms Attribute) Value() pcommon.Value {
	if !ms.orig.HasValue() {
		ms.orig.SetValue(&otlpcommon.AnyValue{})
	}
	return pcommon.Value(internal.NewValue(ms.orig.GetValue(), ms.state))
}
