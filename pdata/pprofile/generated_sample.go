...
func NewSample() Sample {
	...
	return newSample(otlpprofiles.Sample_builder{}.Build(), &state)
}
...
func (ms Sample) LocationsStartIndex() int32 {
	return ms.orig.GetLocationsStartIndex()
}
