...
func NewNumberDataPoint() NumberDataPoint {
	...
	return newNumberDataPoint(otlpmetrics.NumberDataPoint_builder{}.Build(), &state)
}
...
func (ms NumberDataPoint) ValueType() NumberDataPointValueType {
	...
	case otlpmetrics.NumberDataPoint_AsDouble_case:
		return NumberDataPointValueTypeDouble
	case otlpmetrics.NumberDataPoint_AsInt_case:
