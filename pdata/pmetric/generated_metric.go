...
func NewMetric() Metric {
	...
	return newMetric(otlpmetrics.Metric_builder{}.Build(), &state)
}
...
func (ms Metric) Type() MetricType {
	switch ms.orig.WhichData() {
	case otlpmetrics.Metric_Gauge_case:
		return MetricTypeGauge
	case otlpmetrics.Metric_Sum_case:
		return MetricTypeSum
	case otlpmetrics.Metric_Histogram_case:
		return MetricTypeHistogram
	case otlpmetrics.Metric_ExponentialHistogram_case:
		return MetricTypeExponentialHistogram
	case otlpmetrics.Metric_Summary_case:
...
func (ms Metric) ExponentialHistogram() ExponentialHistogram {
	v := ms.orig.GetExponentialHistogram()
	if v == nil {
...
func (ms Metric) SetEmptyExponentialHistogram() ExponentialHistogram {
	...
	ms.orig.SetExponentialHistogram(val)
