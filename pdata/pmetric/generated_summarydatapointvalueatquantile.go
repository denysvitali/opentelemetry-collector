...
func NewSummaryDataPointValueAtQuantile() SummaryDataPointValueAtQuantile {
	...
	return newSummaryDataPointValueAtQuantile(otlpmetrics.SummaryDataPoint_ValueAtQuantile_builder{}.Build(), &state)
}
