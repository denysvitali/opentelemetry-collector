...
func NewLogRecord() LogRecord {
	...
	return newLogRecord(otlplogs.LogRecord_builder{}.Build(), &state)
}
...
func (ms LogRecord) ObservedTimestamp() pcommon.Timestamp {
	return pcommon.Timestamp(ms.orig.GetObservedTimeUnixNano())
}
...
func (ms LogRecord) SetObservedTimestamp(v pcommon.Timestamp) {
	ms.state.AssertMutable()
	ms.orig.SetObservedTimeUnixNano(uint64(v))
}
...
func (ms LogRecord) Flags() LogRecordFlags {
	return LogRecordFlags(ms.orig.GetFlags())
}
...
func (ms LogRecord) SetSeverityNumber(v SeverityNumber) {
	ms.state.AssertMutable()
	ms.orig.SetSeverityNumber(otlplogs.SeverityNumber(v))
}
...
func (ms LogRecord) Body() pcommon.Value {
	if !ms.orig.HasBody() {
		ms.orig.SetBody(&otlpcommon.AnyValue{})
	}
	return pcommon.Value(internal.NewValue(ms.orig.GetBody(), ms.state))
}
